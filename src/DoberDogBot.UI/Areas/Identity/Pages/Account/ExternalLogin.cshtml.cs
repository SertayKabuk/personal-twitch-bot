...
namespace DoberDogBot.UI.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                foreach (var addedClaim in info.Principal.Claims.Where(x => x.Type.StartsWith("urn:")))
                {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        foreach (var item in info.Principal.Claims.Where(x => x.Type.StartsWith("urn:")))
                        {
