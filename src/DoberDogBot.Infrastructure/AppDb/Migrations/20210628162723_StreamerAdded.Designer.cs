...
namespace DoberDogBot.Infrastructure.AppDb.Migrations
{
    ...
    [Migration("20210628162723_StreamerAdded")]
    partial class StreamerAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoberDogBot.Domain.AggregatesModel.StreamerAggregate.Streamer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("_channel")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("Channel");

                    b.Property<string>("_channelId")
                        .IsRequired()
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("DoberDogBot.Domain.AggregatesModel.StreamerAggregate.StreamerSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("_playDelay")
                        .HasColumnType("integer")
                        .HasColumnName("PlayDelay");

                    b.Property<string>("_streamEnd")
                        .HasColumnType("text")
                        .HasColumnName("StreamEnd");

                    b.Property<string>("_streamStart")
                        .IsRequired()
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("DoberDogBot.Domain.AggregatesModel.StreamerAggregate.StreamerSession", b =>
                {
                    b.HasOne("DoberDogBot.Domain.AggregatesModel.StreamerAggregate.Streamer", null)
                        .WithMany("StreamerSessions")
